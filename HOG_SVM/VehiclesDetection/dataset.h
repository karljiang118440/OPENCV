...
#define PosSamNO 5966  //正样本个数
#define NegSamNO 5068    //负样本个数
...
/*
#define PosSamListFile "train_list128x64.txt" //正样本图片的文件名列表
#define NegSamListFile "no-train_list128x64.txt" //负样本图片的文件名列表
*/
